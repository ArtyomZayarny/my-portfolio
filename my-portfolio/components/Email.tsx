...
const Email = () => {
  ...
  const handleSubmit = async (e: FormEvent<HTMLFormElement>) => {
    e.preventDefault();
    const targetObj = e.target as unknown as IFormTarget;

    const data = {
      email: targetObj?.email.value,
      subject: targetObj?.subject.value,
      message: targetObj?.message.value,
    };
    ...
    >
      ...
      <div>
        ...
        <div className="socials flex flex-row gap-2">
          ...
          <Link
            target="_blank"
            href="https://www.linkedin.com/in/artem-zaiarnyi-940431366/"
          >
